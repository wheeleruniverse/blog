  ...
  <div class="relative">
    <div class="relative">
      <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        <MagnifyingGlassIcon class="h-5 w-5 text-wheeler-gray-400 dark:text-wheeler-gray-500" />
      </div>
      <input
        v-model="searchQuery"
        type="text"
        placeholder="Search blog posts..."
        class="block w-full pl-10 pr-10 py-3 text-wheeler-gray-900 dark:text-white placeholder-wheeler-gray-500 dark:placeholder-wheeler-gray-400 bg-white dark:bg-wheeler-gray-800 border border-wheeler-gray-300 dark:border-wheeler-gray-600 rounded-lg focus:ring-2 focus:ring-wheeler-blue-500 focus:border-wheeler-blue-500 dark:focus:ring-wheeler-blue-400 transition-colors duration-200"
