<template>
  <div class="min-h-screen bg-wheeler-gray-50 dark:bg-wheeler-gray-900 flex items-center justify-center">
    <div class="max-w-md mx-auto text-center px-4">
      <div class="space-y-6">
        <!-- 404 Icon -->
        <div class="w-20 h-20 bg-wheeler-gray-200 dark:bg-wheeler-gray-700 rounded-full flex items-center justify-center mx-auto">
          <span class="text-3xl font-bold text-wheeler-gray-600 dark:text-wheeler-gray-400">404</span>
        </div>
        ...
        <div class="pt-6 border-t border-wheeler-gray-200 dark:border-wheeler-gray-700">
          ...
          <div class="flex flex-wrap gap-2 justify-center">
            <router-link
              to="/?search=AWS"
              class="px-3 py-1 bg-wheeler-gray-100 dark:bg-wheeler-gray-800 text-wheeler-gray-700 dark:text-wheeler-gray-300 text-sm rounded-full hover:bg-wheeler-blue-100 dark:hover:bg-wheeler-blue-900 hover:text-wheeler-blue-700 dark:hover:text-wheeler-blue-300 transition-colors duration-200"
            >
              AWS
            </router-link>
            <router-link
              to="/?search=certification"
              class="px-3 py-1 bg-wheeler-gray-100 dark:bg-wheeler-gray-800 text-wheeler-gray-700 dark:text-wheeler-gray-300 text-sm rounded-full hover:bg-wheeler-blue-100 dark:hover:bg-wheeler-blue-900 hover:text-wheeler-blue-700 dark:hover:text-wheeler-blue-300 transition-colors duration-200"
            >
              Certification
            </router-link>
